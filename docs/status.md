...
Empirical status: **PAPER-V2 RUN PAUSED AT E1 FOR TTS BATCHING UPDATE**.
...
- The excluded `paper-v1-efficiency-main-v3` pilot stopped cleanly after
  ...
  statistics.
- Preflight, E3a, TTS-Cal, and 24 E1 jobs are complete. The SQLite database
  passed `integrity_check`; interrupted E1 jobs returned to pending.
